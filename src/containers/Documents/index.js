...
import { setActiveDocument} from "../../api/modules/builder";
...
class Documents extends Component {
  ...
  handleDocumentClick(index, doc) {
    this.setState({selectedDocumentIndex: index});
    this.props.setActiveDocument({document: doc});
  }
    ...
    return (
      <React.Fragment>
        {documents.map((doc, i) => {
          ...
          return (
            <div className="overview-row" style={{cursor: 'pointer'}} key={i} onClick={() => this.handleDocumentClick(i, doc)}>
