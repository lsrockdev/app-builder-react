                ...
                <div className="contact-form-label">
                  ...
                  <div>
                    <input
                      ...
                      onChange={(e)=>{this.handleInput(e,'firstName')}} type="text" name="firstname" tabIndex="1" className="contact-form-input" required=""/>
                  </div>
                </div>
                <div className="contact-form-label">
                  <div>Phone Number *</div>
                  <div>
                    <input val={this.state.phoneNumber}
                    onChange={(e)=>{this.handleInput(e,'phoneNumber')}} type="tel" name="usrtel" tabIndex="4" className="contact-form-input" required=""/>
                  </div>
                </div>
                <div className="contact-form-label">
                  <div>City</div>
                  <div>
                    <input val={this.state.city}
                    onChange={(e)=>{this.handleInput(e,'city')}} type="text" name="city" tabIndex="7" className="contact-form-input"/>
                  </div>
                </div>
              </div>
              <div className="contact-form-item-container">
                <div className="contact-form-label">
                  <div>Last Name *</div>
                  <div>
                    <input val={this.state.lastName}
                    onChange={(e)=>{this.handleInput(e,'lastName')}} type="text" name="lastname" tabIndex="2" className="contact-form-input" required=""/>
                  </div>
                </div>
                <div className="contact-form-label">
                  <div>Account Number *</div>
                  <div>
                    <input val={this.state.accountNumber}
                    onChange={(e)=>{this.handleInput(e,'accountNumber')}} type="text" name="accnumber" tabIndex="5" className="contact-form-input" required=""/>
                  </div>
                </div>
                <div className="contact-form-label">
                  <div>State/Province</div>
                  <div>
                    <input val={this.state.stateOrProvince}
                    onChange={(e)=>{this.handleInput(e,'stateOrProvince')}} type="text" name="state" tabIndex="8" className="contact-form-input"/>
                  </div>
                </div>
              </div>
              <div className="contact-form-item-container">
                <div className="contact-form-label">
                  ...
                  <div>
                    <input val={this.state.email}
                    onChange={(e)=>{this.handleInput(e,'email')}} type="email" name="email" tabIndex="3" className="contact-form-input" required=""/>
                  </div>
                </div>
                <div className="contact-form-label">
                  <div>Company</div>
                  <div>
                    <input val={this.state.company}
                    onChange={(e)=>{this.handleInput(e,'company')}} type="text" name="company" tabIndex="6" className="contact-form-input"/>
                  </div>
                </div>
                <div className="contact-form-label">
                  <div>Country</div>
                  <div>
                    <input val={this.state.country}
                    onChange={(e)=>{this.handleInput(e,'country')}} type="text" name="country" tabIndex="9" className="contact-form-input"/>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="contact-form-subsection">
              <div className="contact-form-subsection-body contact-form-subsection-radio-body">
                <div className="contact-form-radio-col">
                  <div>
                    <input type="radio" name="issue" tabIndex="10" id="support-technical-issue-input-login-difficulties"
                      value="login-difficulties"
                      checked={this.state.technicalIssue === "login-difficulties"}
                      onChange={(e)=>{this.handleInput(e,'technicalIssue')}}
                  ...
                  <div>
                    <input type="radio" name="issue" tabIndex="-1" id="support-technical-issue-input-document-creation"
                ...
                <div className="contact-form-radio-col">
                  <div>
                    <input type="radio" name="issue" tabIndex="-1" id="support-technical-issue-input-library-creation"
                  ...
                  <div>
                    <input type="radio" name="issue" tabIndex="-1" id="support-technical-issue-input-document-preview"
                ...
                <div className="contact-form-radio-col">
                  <div>
                    <input type="radio" name="issue" tabIndex="-1" id="support-technical-issue-input-content-variables"
                  ...
                  <div>
                    <input type="radio" name="issue" tabIndex="-1" id="support-technical-issue-input-document-export"
              ...
              <div className="contact-form-subsection-body">
                <div>
                  <textarea
                    ...
                    onChange={(e)=>{this.handleInput(e,'message')}} className="contact-form-textarea" name="textarea" rows="3" cols="50" tabIndex="11">
                  </textarea>
                </div>
                <div>
